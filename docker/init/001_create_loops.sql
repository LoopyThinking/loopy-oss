-- Self-hosted init: loops table
-- Adapted from packages/db/migrations/001_create_loops.sql
-- RLS is NOT enabled here — user isolation is enforced by the API middleware.
